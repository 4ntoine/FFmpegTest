...
public class FFmpegWrapper {
    ...
    public native void prepareAVFormatContext(String jOutputPath, int audioStreamsCount, int videoStreamsCount);
    private native void writeAVPacketFromEncodedData(ByteBuffer jData, int jIsVideo, int videoStreamIndex, int jOffset, int jSize, int jFlags, long jPts);

    private Object writeSync = new Object();

    public void syncWriteAVPacketFromEncodedData(ByteBuffer jData, int jIsVideo, int videoStreamIndex, int jOffset, int jSize, int jFlags, long jPts) {
        synchronized(writeSync) {
            writeAVPacketFromEncodedData(jData, jIsVideo, videoStreamIndex, jOffset, jSize, jFlags, jPts);
        }
    }
